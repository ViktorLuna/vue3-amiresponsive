<template>
    <div style="display: flex; justify-content: center; background-color: blue;">
        <div style="display: flex; justify-content: center; position: relative; width: 900px; height: 850px; background-color: red;">
